package org.example.recursos.listasEnlazadasGenericas;
...
public class ListaDoble<T> implements Iterable<T>, Serializable {
     ...
     * parametro indice índice donde se va a guardar el dato
     * parametro nuevo El valor a guardar
     */
    ...
    protected class IteradorListaDoble implements Iterator<T>{
         ...
         * parametro aux Primer Nodo de la lista
         */
    ...
    public void imprimirHaciaAtras() {
        ...
        while (nodoAux != null) {
            System.out.print( nodoAux.getValorNodo()+"\n" );
            nodoAux = nodoAux.getAnteriorNodo();
        }
        System.out.println();
