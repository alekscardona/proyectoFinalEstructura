...
public class ListaSimpleCircular<T> implements Iterable<T> {
    ...
    public void insertar(T valorNodo, int posicion) {
    ...
    public boolean buscar(T valorNodo) {
        ...
        do {
            if (actual.getValorNodo().equals(valorNodo)) {
                return true;
            }
...
//				nodoUltimo = null;
    ...
    public void setTamanio(int tamanioo) {
